def test_errors(**arguments):
    ...
    if "coordinates" in arguments:
        ...
        assert 0 <= coordinates[0] < grid_size and 0 <= coordinates[1] < grid_size, f"The `coordinates` argument must contains integers between 0 and grid_size - 1 (value : {coordinates})"
